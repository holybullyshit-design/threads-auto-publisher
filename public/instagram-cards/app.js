...
function drawPromo(c,s){if(lightBrandBg.complete)c.drawImage(lightBrandBg,0,0,1080,1350);c.textAlign='center';c.fillStyle='#745228';c.font='700 27px "Apple SD Gothic Neo",sans-serif';c.fillText('나의 때와 마음의 흐름을 읽는',540,85);drawLogo(c,425,115,230);c.fillStyle='#3d291b';c.font='108px "PaljaBrush","AppleMyungjo",serif';c.fillText('팔자명가',540,455);c.fillStyle='#75572f';c.font='28px "AppleMyungjo",serif';c.fillText('오늘의 운을 넘어, 나에게 맞는 때를 봅니다',540,510);const stats=[['7,000건+','누적 상담'],['2,100개+','상담 후기']];stats.forEach((v,i)=>{const x=133+i*414;c.fillStyle='rgba(255,252,242,.73)';roundRect(c,x,690,386,220,14);c.fillStyle='#3f2a1c';c.font='700 58px "Apple SD Gothic Neo",sans-serif';c.fillText(v[0],x+193,790);c.fillStyle='#8b642e';c.font='700 28px "Apple SD Gothic Neo",sans-serif';c.fillText(v[1],x+193,845)});c.fillStyle='#4e3823';c.font='700 32px "Apple SD Gothic Neo",sans-serif';c.fillText('연애운 · 재물운 · 직장운 · 가족운',540,1005);c.fillStyle='#665038';c.font='26px "AppleMyungjo",serif';c.fillText('관계와 선택, 인생의 방향이 궁금한 순간',540,1060);c.fillText('사주의 흐름을 깊이 있게 함께 읽어드립니다',540,1105);c.fillStyle='#9f3f31';c.font='700 31px "Apple SD Gothic Neo",sans-serif';c.fillText('상담 신청은 팔자명가 프로필 링크에서',540,1210);c.textAlign='left'}
